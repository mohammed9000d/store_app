            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                        {{--                            <a href="{{ route('products.trash') }}"  class="btn btn-light-danger me-3">--}}
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer">
                            ...
                            <tr class="text-start text-muted fw-bolder fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                    colspan="1" aria-label="Role: activate to sort column ascending"
                                    style="width: 126.109px;">Category Name
                                </th>
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                    colspan="1" aria-label="Role: activate to sort column ascending"
                                    style="width: 126.109px;">Price
                                </th>
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                                    colspan="1" aria-label="Role: activate to sort column ascending"
                                    style="width: 126.109px;">Quantity
                                </th>
                                <th class="min-w-125px sorting" tabindex="0" aria-controls="kt_table_users" rowspan="1"
                            ...
                            @foreach($products as $product)
                                <tr class="odd">
                                    <td>
                                        <img src="{{ $product->image_url }}" alt="{{ $product->name }}" width="70" height="50" style="object-fit: cover">
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <button wire:click="edit({{$product->id}})" type="button" class="btn btn-primary active" data-bs-toggle="modal" data-bs-target="#kt_modal_2">
                                        ...
                                        <button wire:click="$emit('triggerDelete',{{ $product->id }})" type="button" class="btn btn-danger">
