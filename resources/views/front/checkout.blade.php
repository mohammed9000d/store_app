            ...
            <div class="row">
                <div class="col-md-7">
                    <div class="row group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="billing_name" value="John Doe" required="" placeholder="Enter Your Name" />
                        </div>
                    </div>

                    <div class="row group">
                        <div class="col-sm-4"><h2 class="h4">E-mail</h2></div>
                        <div class="col-sm-8"> <input type="email" class="form-control" name="billing_email" value="john@yahoo.com" required="" placeholder="Enter Your E-mail" />
                        </div>
                    </div>
                    ...
                    <div class="row group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="billing_phone" value="+45 (555) 8546-25-77" required="" placeholder="Enter Your Phone" />
                        </div>
                    </div>
                    ...
                    <div class="row group">
                        ...
                        <div class="col-sm-8">
                            ...
                            <div class="group-select justify" tabindex='1'>
                                <input class="form-control select" id="country" name="billing_country" value="United Kingdom" placeholder="" required="" />
                    ...
                    <div class="">
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control" name="billing_city" value="" required="" placeholder="Enter Your City" />
                            </div>
                            <div class="col-sm-4">
                                <h2 class="h4">Address</h2>

                                <input type="text" class="form-control" name="billing_address" value="" required="" placeholder="Enter Your Address" />
                            </div>
{{--                            <div class="col-sm-2">--}}
                        ...
                        @foreach($cart as $item)
                                <div class="media">
                                    <div class="media-left">
                                        <a href="#">
                                            <img class="media-object" src="{{ $item->product->image }}" alt="iPad Air"/>
                                        </a>
                                    </div>
                ...
                <div class="col-sm-12 white">
                    ...
                    <div class="row">
                        <div class="col-xs-6 col-md-4">
                            ...
                            <h3 class="h4 no-margin">Total: ${{ $total - $item->product->discount }}</h3>
                        </div>
