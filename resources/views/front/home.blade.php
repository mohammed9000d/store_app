        ...
        <div class="carousel" data-count="3" data-current="1">
            ...
            <div class="items">
                ...
                <div class="item center" data-marker="1">
                    <img src="{{asset('front/assets/img/carousel/bckg-2.jpg')}}" alt="Background" class="background hidden-xs hidden-sm"/>
                    <img src="{{asset('front/assets/img/carousel/bckg-2-sm.jpg')}}" alt="Background" class="background visible-sm"/>
                    <img src="{{asset('front/assets/img/carousel/bckg-2-xs.jpg')}}" alt="Background" class="background visible-xs"/>
                        ...
                        <div class="outside-content">
                            <div class="inside-content">
                                <div class="container align-right">
                                    ...
                                    <hr class="offset-md">
                                    <hr class="offset-md">
                                    <a href="./store/" rel="nofollow" class="btn btn-primary btn-lg black"> More
                                        laptops </a>
                ...
                <div class="item" data-marker="2">
                    <img src="{{asset('front/assets/img/carousel/bckg-1.jpg')}}" alt="Background" class="background hidden-xs hidden-sm"/>
                    <img src="{{asset('front/assets/img/carousel/bckg-1-sm.jpg')}}" alt="Background" class="background visible-sm"/>
                    <img src="{{asset('front/assets/img/carousel/bckg-1-xs.jpg')}}" alt="Background" class="background visible-xs"/>

                <!-- <img src="{{asset('front/assets/img/carousel/newlaptops.jpg')}}" alt="New laptops" title="New laptops" class="item-left hidden-xs"/> -->
                ...
                <div class="item" data-marker="3">
                    <img src="{{asset('front/assets/img/carousel/bckg-3.jpg')}}" alt="Background" class="background hidden-xs hidden-sm"/>
                    <img src="{{asset('front/assets/img/carousel/bckg-3-sm.jpg')}}" alt="Background" class="background visible-sm"/>
                    <img src="{{asset('front/assets/img/carousel/bckg-3-xs.jpg')}}" alt="Background" class="background visible-xs"/>

                <!-- <img src="{{asset('front/assets/img/carousel/ipadair2.jpg')}}" alt="Apple Devices" title="Apple Devices" class="item-right hidden-xs"/> -->
                        ...
                        <div class="outside-content">
                            <div class="inside-content">
                                <div class="container align-right">
                                    ...
                                    <h1 class="h3 colorful blue hidden-xs">Luxury watches, business tablets and 3D touch:
                                        <br> How Apple plans to stay ahead in mobile.</h1>

                                    <hr class="offset-sm">
                                    <h2 class="h1 lg upp colorful blue">Brand new day <br class="hidden-xs"> for business
                                    </h2>
                                    <hr class="offset-md">
                                    <hr class="offset-md">
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 col-md-4 no-padding padding-xs">
                    <div class="bar medium" data-background="{{asset('front/assets/img/bars/macbook.jpg')}}">
                ...
                <div class="col-sm-6 col-md-4">
                    <div class="bar small" data-background="{{asset('front/assets/img/bars/dellinspirion.jpg')}}">
                    ...
                    <div class="bar small" data-background="{{asset('front/assets/img/bars/surfacestudio.jpg')}}">
                ...
                <div class="col-sm-6 col-md-4 no-padding hidden-xs hidden-sm">
                    <div class="bar medium" data-background="{{asset('front/assets/img/bars/accessories.jpg')}}">
            ...
            <div class="row">
                @foreach($products as $product)
                    <div class="col-sm-6 col-md-3 product">
                        <div class="body">
                            <a href="{{ route('product-details', $product->slug) }}" class="favorites" data-favorite="inactive"><i
                                    class="ion-ios-heart-outline"></i></a>
                            <a href="{{ route('product-details', $product->slug) }}"><img src="{{ $product->image }}"
                                              alt="{{ $product->name }}"/></a>
                            <div class="content align-center">
                                ...
                                <a href="{{ route('product-details', $product->slug) }}" class="btn btn-link"><i class="ion-android-open"></i> Details</a>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 product">
                    <div class="body">
                        <a href="#favorites" class="favorites" data-favorite="inactive"><i
                                class="ion-ios-heart-outline"></i></a>
                        <a href="./"><img src="{{asset('front/assets/img/products/lenovo-yoga.jpg')}}" alt="Lenovo Yoga 900"/></a>
                ...
                <div class="col-sm-6 col-md-4 product">
                    <div class="body">
                        <a href="#favorites" class="favorites" data-favorite="inactive"><i
                                class="ion-ios-heart-outline"></i></a>
                        <a href="./"><img src="{{asset('front/assets/img/products/surface-pro.jpg')}}" alt="Surface Pro"/></a>
                ...
                <div class="col-sm-6 col-md-4 product">
                    <div class="body">
                        <a href="#favorites" class="favorites" data-favorite="inactive"><i
                                class="ion-ios-heart-outline"></i></a>
                        <a href="./"><img src="{{asset('front/assets/img/products/hp-spectre-x360.jpg')}}" alt="HP Spectre x360"/></a>
                ...
                <div class="col-sm-6 col-md-4 product visible-sm">
                    <div class="body">
                        <a href="#favorites" class="favorites" data-favorite="inactive"><i
                                class="ion-ios-heart-outline"></i></a>
                        <a href="./"><img src="{{asset('front/assets/img/products/dell-inspiron-2in1.jpg')}}"
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-4 product">
                    <div class="body">
                        <a href="#favorites" class="favorites" data-favorite="inactive"><i
                                class="ion-ios-heart-outline"></i></a>
                        <a href="./"><img src="{{asset('front/assets/img/products/mi-pad-2.jpg')}}" alt="Xiamomi Mi Pad 2"/></a>
                ...
                <div class="col-sm-6 col-md-4 product">
                    <div class="body">
                        <a href="#favorites" class="favorites" data-favorite="inactive"><i
                                class="ion-ios-heart-outline"></i></a>
                        <a href="./"><img src="{{asset('front/assets/img/products/ipad-air.jpg')}}" alt="Apple iPad Air"/></a>
                ...
                <div class="col-sm-6 col-md-4 product">
                    <div class="body">
                        <a href="#favorites" class="favorites" data-favorite="inactive"><i
                                class="ion-ios-heart-outline"></i></a>
                        <a href="./"><img src="{{asset('front/assets/img/products/asus-transformer.jpg')}}" alt="Asus Transformer"/></a>
                ...
                <div class="col-sm-6 col-md-4 product visible-sm">
                    <div class="body">
                        <a href="#favorites" class="favorites" data-favorite="inactive"><i
                                class="ion-ios-heart-outline"></i></a>
                        <a href="./"><img src="{{asset('front/assets/img/products/ipad-mini.jpg')}}" alt="iPad Mini"/></a>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 item">
                    ...
                    <div class="body">
                        ...
                        <a href="#">
                            <img src="{{asset('front/assets/img/blog/img1.jpg')}}" title="Apple Devices" alt="Apple Devices">
                        </a>
                ...
                <div class="col-sm-6 col-md-6 item">
                    ...
                    <div class="body">
                        <a href="#" class="view"><i class="ion-ios-book-outline"></i></a>
                        <a href="#">
                            <img src="{{asset('front/assets/img/blog/img2.jpg')}}" title="Coffee" alt="Coffee">
                        </a>
